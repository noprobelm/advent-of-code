...
if __name__ == '__main__':
    ...
    print(f"The number of elf's tasks who fully overlap their partner's tasks is {num_subsets}")
    print(f"The number of elf's tasks who have any degree of overlap with their partner's tasks is {intersections}")
